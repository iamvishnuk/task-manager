      ...
      <div className='mt-8 flex flex-wrap items-center justify-between gap-4 border-t border-slate-100 pt-6 dark:border-slate-800/60'>
        <div className='flex items-center gap-3.5'>
          <Button
            ...
            className='bg-blue-800 text-white hover:cursor-pointer hover:bg-blue-900 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-blue-800 dark:hover:bg-blue-900'
          >
            {task.status === 'DONE'
              ? 'Mark Incomplete'
              : task.status === 'IN_PROGRESS'
          ...
          <Button
            ...
            onClick={onEdit}
            disabled={isPending || isAdmin}
            className='inline-flex items-center gap-1.5 hover:cursor-pointer disabled:cursor-not-allowed disabled:opacity-50'
          >
        ...
        <button
          onClick={onDelete}
          disabled={isPending || isAdmin}
          className='inline-flex items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-bold text-red-600 hover:cursor-pointer hover:bg-red-50 disabled:cursor-not-allowed disabled:opacity-50 dark:text-red-400 dark:hover:bg-red-950/30'
        >
